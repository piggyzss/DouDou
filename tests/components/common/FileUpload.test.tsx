...
describe('FileUpload Component', () => {
  ...
  it('renders with custom className', () => {
    ...
    const uploadArea = screen.getByText(/Click to upload files/i).closest('div').parentElement
  ...
  it('handles multiple file selection when multiple prop is true', async () => {
    ...
    mockFetch
      .mockResolvedValueOnce({
        ok: true,
        json: async () => ({ success: true, url: 'https://example.com/file1.jpg' })
      } as Response)
      .mockResolvedValueOnce({
        ok: true,
        json: async () => ({ success: true, url: 'https://example.com/file2.jpg' })
      } as Response)
