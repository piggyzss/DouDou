...
import { X, Play, Pause, Settings, Volume1, Volume2, VolumeX, SkipBack, SkipForward, Hand } from 'lucide-react'
        ...
        >
          ...
          <div className="relative h-[60vh] bg-white overflow-hidden">
            ...
            <div className="relative z-10 h-full w-full overflow-hidden">
              <video
                ref={videoRef}
                src={videoUrl ? `/api/apps/proxy-video?url=${encodeURIComponent(videoUrl)}` : ''}
