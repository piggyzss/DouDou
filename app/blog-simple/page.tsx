...
export default async function SimpleBlogPage() {
  try {
    ...
    const result = await BlogModel.findAllPublished(1, 2)
    
    return (
      <div className="min-h-screen pt-16">
        <div className="w-full py-12 relative">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-text-primary font-heading">博客文章（简化版）</h1>
            <p className="text-text-secondary mt-1 font-blog">测试BlogModel调用</p>
          </div>
