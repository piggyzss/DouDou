          ...
          >
            ...
            <div className={`${
              ...
              <div className="flex gap-1">
                ...
                <div className="w-2 h-2 rounded-full style={{backgroundColor: '#fed336'}}"></div>
                ...
                {loading ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className={`flex items-center gap-2 mt-3 ${
                      isDarkMode ? 'text-[var(--code-green)]' : 'text-[#53b88f]'
                    }`}>
                    ...
                    {latestApp.tags && latestApp.tags.length > 0 && (
                      <div className="flex flex-wrap gap-1 mt-2">
                        {latestApp.tags.slice(0, 3).map((tag, index) => (
                          <span
                            key={index}
                            className={`px-2 py-1 text-xs rounded font-light ${
                              isDarkMode 
                  ...
                  <div className="space-y-2">
                    ...
                    {latestArtwork.images && latestArtwork.images.length > 0 ? (
                      <div className={`mt-3 p-2 rounded border ${
                        ...
                        <div className={`text-xs mb-1 font-light ${
                          isDarkMode ? 'text-gray-400' : 'text-gray-600'
                        }`}>preview:</div>
