...
export default async function BlogTestPage() {
  try {
    ...
    return (
      <div className="min-h-screen pt-16">
        <div className="w-full py-12 relative">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-text-primary font-heading">博客文章（测试版）</h1>
            <p className="text-text-secondary mt-1 font-blog">测试Link组件的博客页面</p>
          </div>
          ...
          <div className="mt-8">
            <Link href="/blog-simple" className="text-blue-600 hover:underline">
              查看简化版博客页面
            </Link>
          </div>
        </div>
    ...
    console.error('博客测试页面错误:', error)
    
    return (
      <div className="min-h-screen pt-16">
        <div className="w-full py-12 relative">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-red-600">博客测试页面错误</h1>
          </div>
