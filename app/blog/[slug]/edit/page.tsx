      ...
      <div className="w-full py-8">
        ...
        <div className="mb-6 flex justify-between items-center">
          <div className="flex space-x-3">
            ...
            <button onClick={() => router.push(`/blog/${slug}`)} className={SECONDARY_BTN}>取消</button>
          </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input value={title} disabled className="w-full px-3 py-2 rounded-md border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-text-secondary outline-none font-blog" />
          </div>

          {/* 封面上传，与新建页一致 */}
          <div>
            <label className="block text-sm text-text-muted mb-1 font-blog">封面图片</label>
            <input
              ref={fileInputRef}
              type="file"
              accept="image/*"
            ...
            {coverPreview && (
              <div className="mt-2">
                <img
                  src={coverPreview.startsWith('data:') || coverPreview.startsWith('/') || coverPreview.startsWith('/api/aigc/proxy-image')
                    ? coverPreview
          ...
          <div>
            ...
            <input value={tags} onChange={e=>setTags(e.target.value)} className="w-full px-3 py-2 rounded-md border border-gray-200 dark:border-gray-700 bg-bg-secondary outline-none focus:ring-2 focus:ring-primary font-blog" />
          </div>
          <div>
