        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-md border border-gray-200 dark:border-gray-700 bg-bg-secondary outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
          ...
          <div className="flex gap-3 justify-end mt-6">
            <button onClick={() => router.back()} className={SECONDARY_BTN}>
              取消
            </button>
            <button
              onClick={save}
