    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {videos.map((video) => (
          <div
            key={video.id}
            className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded hover:shadow-lg transition-all duration-300 overflow-hidden group relative"
          >
            ...
            <div className="p-2">
              <div className="flex items-center gap-1 relative mb-2">
                <h3 className="text-base font-semibold text-text-primary font-heading truncate max-w-[calc(100%-28px)]">
                  {video.title}
                </h3>
              ...
              <div className="flex items-center gap-2 text-[11px] text-text-muted">
                ...
                <div className="flex items-center gap-1">
                  <LikeToggle
                    ...
                    onChanged={(_, count) => {
                      onUpdateVideoLikes?.(video.id, count);
                    }}
                  />
                </div>
                <span className="mx-0.5 inline-flex items-center justify-center text-[11px] leading-none text-text-muted translate-y-[2px] select-none">
