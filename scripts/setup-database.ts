...
async function createTables() {
  ...
  try {
    ...
    await client.query(`CREATE INDEX IF NOT EXISTS idx_artwork_collections_tags ON artwork_collections USING GIN(tags)`)
    await client.query(`CREATE INDEX IF NOT EXISTS idx_artwork_images_collection_id ON artwork_images(collection_id)`)
    ...
    await client.query(`CREATE INDEX IF NOT EXISTS idx_blog_tags_slug ON blog_tags(slug)`)
    await client.query(`CREATE INDEX IF NOT EXISTS idx_blog_post_tags_post_id ON blog_post_tags(post_id)`)
